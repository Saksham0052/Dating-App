    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            SizedBox(
              height: screenheight / 1.9, // Adjust height as needed
              child: PageView.builder(
                ...
                itemBuilder: (_, i) {
                  return Container(
                    margin: const EdgeInsets.only(top: 0, bottom: 950),
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        ...
                        height: screenheight / 2.2, // Adjust height to control layout
                        width: double.infinity, // Stretch image width to match container
                      ),
                    ),
                  );
                },
